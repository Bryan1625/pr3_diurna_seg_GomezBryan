package programacion3.parcial3.cliente.persistence;
...
import programacion3.parcial3.cliente.ejercicio3.Autor;
import programacion3.parcial3.cliente.ejercicio3.TrabajoGrado;
import programacion3.parcial3.cliente.ejercicio3.Universidad;
public class Persistencia {
	public static final String RUTA_ARCHIVO_TRABAJOS_GRADO = "C:\\td\\archivos\\trabajosGrado.txt";
	public static final String RUTA_ARCHIVO_AUTORES = "C:\\td\\archivos\\autores.txt";
...
//	----------------------LOADS------------------------
	...
	public static ArrayList<TrabajoGrado> cargarTrabajosGrado() throws FileNotFoundException, IOException 
	{
		...
		for (int i = 0; i < contenido.size(); i++)
		{
			...
			autor2.setNombre(linea.split("@")[8]);
			autor2.setApellido(linea.split("@")[9]);
			autor2.setCedula(linea.split("@")[10]);
			autor2.setPrograma(linea.split("@")[11]);
			autor2.setTitulo(linea.split("@")[12]);
			trabajoGrado.getAutores().add(autor2);
